...
public class UserSim implements Runnable {
    ...
    private Price makeRandomOrderPrice(BookSide side, String product) throws InvalidStringOperation { // This should match your format for storing a side - enum, String, etc
    ...
    private Price makeRandomPrice(BookSide side, String product) throws InvalidStringOperation { // This should match your format for storing a side - enum, String, etc
